...
/*    public PropertyChangeRegistry getPropertyChangeRegistry() {
    ...
    public Blood Hydrate(Cursor cursor) {
        ...
        s2Hydrate(cursor.getString(cursor.getColumnIndex(BloodTable.COLUMN_S2)));
        s3Hydrate(cursor.getString(cursor.getColumnIndex(BloodTable.COLUMN_S3)));
        s4Hydrate(cursor.getString(cursor.getColumnIndex(BloodTable.COLUMN_S4)));
        s5Hydrate(cursor.getString(cursor.getColumnIndex(BloodTable.COLUMN_S5)));
    ...
    public JSONObject toJSONObject() {
        ...
        try {
            ...
            json.put(BloodTable.COLUMN_S2, new JSONObject(s2toString()));
            json.put(BloodTable.COLUMN_S3, new JSONObject(s3toString()));
            json.put(BloodTable.COLUMN_S4, new JSONObject(s4toString()));
            json.put(BloodTable.COLUMN_S5, new JSONObject(s5toString()));
